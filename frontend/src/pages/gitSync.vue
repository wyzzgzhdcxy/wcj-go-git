    ...
    <el-row :gutter="0">
      <el-col :span="24">
        <el-card class="操作区">
          ...
          <el-table :data="repoList" border style="width: 100%" class="repo-table">
            ...
            <el-table-column label="上次同步" width="160" align="center">
              <template #default="scope">
                <span v-if="scope.row.lastSyncTime" class="sync-time">
                  {{ scope.row.lastSyncTime.replace('T', ' ').split('Z')[0] }}
                </span>
